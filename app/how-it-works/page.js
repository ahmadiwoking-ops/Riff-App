...
export default function HowItWorks() {
  ...
  return (
    <PageShell title="How Riff works" subtitle="THE PROCESS" accent="#8B5CF6">
      <p style={{ marginBottom: 24, fontSize: 17 }}>Riff replaces shallow networking with a five-stage journey from anonymous questions to a real connection. Each stage earns trust before the next one unlocks.</p>
      {stages.map((s, i) => (
