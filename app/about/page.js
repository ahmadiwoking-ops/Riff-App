...
export const metadata = { title: 'About Riff', description: 'We are building the antidote to superficial networking. Real connection through conversation, trust, and patience.' };
export default function About() {
  return (
    <PageShell title="About Riff" subtitle="OUR STORY" accent="#8B5CF6">
      <p style={{ marginBottom: 16, fontSize: 17 }}>Riff exists because superficial networking is broken. Not just inefficient — broken. It rewards appearances over substance, speed over depth, and quantity over quality.</p>
      ...
      <p style={{ marginBottom: 16 }}>The average social app user spends hours scrolling through profiles and feels more disconnected afterwards. People are lonelier than ever despite having more ways to connect than ever. Something is fundamentally wrong with the model.</p>
      ...
      <p style={{ marginBottom: 16 }}>This is not faster networking. It is deeper connection. Some users find their person in a week. Some take months. The speed does not matter — the quality does.</p>
