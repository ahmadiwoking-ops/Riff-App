...
export default function Press() {
  return (
    <PageShell title="Press" subtitle="MEDIA" accent="#22D3EE">
      ...
      <p style={{ marginBottom: 16 }}>Riff is a social connection app that matches people through questions, voice, and trust — not photos and swiping. Users understand each other before they see each other, talking by text and voice before a mutual, simultaneous photo reveal.</p>
